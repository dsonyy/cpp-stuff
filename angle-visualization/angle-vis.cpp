...
void input() {
    ...
    while (!quit) {
        ...
        if (action == 'Q') {
            ...
            std::cerr << "Unknown transformation." << std::endl;
        }
    }
}
...
int main()
{
    ...
    while (!quit)
    {
        ...
        sf::RenderWindow window(sf::VideoMode(600, 600), "Angle Visualization", sf::Style::Default, contextSettings);
